      ...
      {num404 !== "0000" && (
        <div className="min-h-screen w-full flex items-center justify-center flex-col animate-fadeIn">
          ...
          <p className="text-fun-gray text-xl mt-8 flex items-center">
            Wrong Addrress!&nbsp;&nbsp;
            <Link href="/">
              <span className="w-full sm:w-auto flex-shrink border border-medium-pink-light text-base px-4 py-1 rounded-xl text-fun-pink-light bg-fun-pink-darkerer hover:bg-medium-pink hover:text-white transition-colors cursor-pointer">
                Return Home
              </span>
            </Link>
          </p>
